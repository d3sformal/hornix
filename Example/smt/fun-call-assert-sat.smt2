...
(declare-fun |?bar@@YAHHH@Z5_entry| ( Int Int Int Bool Bool Bool Bool) Bool )
(declare-fun |?bar@@YAHHH@Z5_exit| ( Int Int Int Bool Bool Bool Bool) Bool )

(assert 
 (forall ( ( %x4 Int )( %x5 Int ) )
  (=>  
   true
   (?bar@@YAHHH@Z0_entry %x5 %x4 )
  )
 )
)
(assert 
 (forall ( ( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool ) )
  (=>  
   (?bar@@YAHHH@Z0_entry %x5 %x4 )
   (?bar@@YAHHH@Z1_entry %x3 %x5 %x4 %x6 )
  )
 )
)
(assert 
 (forall ( ( %x3 Int )( %x3p Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x6p Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_entry %x3 %x5 %x4 %x6 )(= %x3p (- %x4 %x5 ))(= %x6p ( >=  %x4 0 )))
   (?bar@@YAHHH@Z1_exit %x3p %x5 %x4 %x6p )
  )
 )
)
(assert 
 (forall ( ( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_exit %x3 %x5 %x4 %x6 )(= %x6 true ))
...
(assert 
 (forall ( ( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_exit %x3 %x5 %x4 %x6 )(= %x6 false ))
...
(assert 
 (forall ( ( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool )( %x9p Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z2_entry %x3 %x4 %x5 %x6 %x9 )(= %x9p ( >=  %x5 0 )))
...
(assert 
 (forall ( ( %x12 Bool )( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   ...
   (?bar@@YAHHH@Z3_entry %x3 %x5 %x4 %x6 %x9 %x12 )
  )
 )
)
(assert 
...
(assert 
 (forall ( ( %x12 Bool )( %x12p Bool )( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z3_entry %x3 %x5 %x4 %x6 %x9 %x12 )(= %x12p ( >  %x4 %x3 )))
   (?bar@@YAHHH@Z3_exit %x3 %x5 %x4 %x6 %x9 %x12p )
  )
 )
)
(assert 
 (forall ( ( %x12 Bool )( %x18p Bool )( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z3_exit %x3 %x5 %x4 %x6 %x9 %x12 )(= %x18p true )(?bar@@YAHHH@Z3_exit %x3 %x5 %x4 %x6 %x9 %x12 )(= %x12 true ))
   (?bar@@YAHHH@Z5_entry %x3 %x5 %x4 %x18p %x6 %x9 %x12 )
  )
 )
)
(assert 
 (forall ( ( %x12 Bool )( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z3_exit %x3 %x5 %x4 %x6 %x9 %x12 )(= %x12 false ))
   (?bar@@YAHHH@Z %x4 %x5 %x3 false true )
  )
 )
)
(assert 
 (forall ( ( %x12 Bool )( %x18 Bool )( %x3 Int )( %x4 Int )( %x5 Int )( %x6 Bool )( %x9 Bool ) )
  (=>  
   (?bar@@YAHHH@Z5_entry %x3 %x5 %x4 %x18 %x6 %x9 %x12 )
   (?bar@@YAHHH@Z5_exit %x3 %x5 %x4 %x18 %x6 %x9 %x12 )
  )
 )
)
(assert 
...
(declare-fun |main4_entry| ( Int Int Bool Int Bool Bool) Bool )
(declare-fun |main4_exit| ( Int Int Bool Int Bool Bool) Bool )
...
(assert 
 (forall ( ( %x21 Int )( %x21p Int )( %x24 Int )( %x24p Int )( %x26 Int )( %x26p Int )( %x27 Bool )( %x27p Bool )( e1 Bool )( e2 Bool )( e3 Bool ) )
  (=>  
   (and (main1_entry %x26 %x21 %x27 %x24 )(?foo@@YAHHH@Z 10 1 %x21p false e1 )(?bar@@YAHHH@Z %x21p 1 %x24p e1 e2 )(?bar@@YAHHH@Z %x21p %x24p %x26p e2 e3 )(= %x27p ( =  %x26p 1 )))
   (main1_exit %x26p %x21p %x27p %x24p e3 )
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( %x31 Bool ) )
  (=>  
   (and (main1_exit %x26 %x21 %x27 %x24 false )(= %x27 true ))
   (main2_entry %x21 %x26 %x31 %x24 %x27 )
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( e3 Bool ) )
  (=>  
   (and (main1_exit %x26 %x21 %x27 %x24 e3 )(= %x27 false ))
   main_error
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool ) )
  (=>  
   (main1_exit %x26 %x21 %x27 %x24 true )
   main_error
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( %x31 Bool )( %x31p Bool ) )
  (=>  
   (and (main2_entry %x21 %x26 %x31 %x24 %x27 )(= %x31p ( =  %x24 10 )))
   (main2_exit %x21 %x26 %x31p %x24 %x27 )
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( %x31 Bool )( %x41p Bool ) )
  (=>  
   (and (main2_exit %x21 %x26 %x31 %x24 %x27 )(= %x41p true )(main2_exit %x21 %x26 %x31 %x24 %x27 )(= %x31 true ))
   (main4_entry %x26 %x21 %x31 %x24 %x27 %x41p )
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( %x31 Bool ) )
  (=>  
   (and (main2_exit %x21 %x26 %x31 %x24 %x27 )(= %x31 false ))
   main_error
  )
 )
)
(assert 
 (forall ( ( %x21 Int )( %x24 Int )( %x26 Int )( %x27 Bool )( %x31 Bool )( %x41 Bool ) )
  (=>  
   (main4_entry %x26 %x21 %x31 %x24 %x27 %x41 )
   (main4_exit %x26 %x21 %x31 %x24 %x27 %x41 )
  )
 )
)
(assert 
