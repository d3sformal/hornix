...
(declare-fun |?bar@@YAHHH@Z1_entry| ( Int Int Bool Int) Bool )
(declare-fun |?bar@@YAHHH@Z1_exit| ( Int Int Bool Int) Bool )
(declare-fun |?bar@@YAHHH@Z3_entry| ( Int Int Bool Int) Bool )
(declare-fun |?bar@@YAHHH@Z| ( Int Int Int Bool Bool) Bool )
(declare-fun |?bar@@YAHHH@Z3_exit| ( Int Int Bool Int) Bool )
...
(assert 
 (forall ( ( %x0 Int )( %x1 Int )( %x2 Int )( %x3 Bool ) )
  (=>  
   (?bar@@YAHHH@Z0_entry %x1 %x0 )
   (?bar@@YAHHH@Z1_entry %x1 %x0 %x3 %x2 )
  )
 )
)
(assert 
 (forall ( ( %x0 Int )( %x1 Int )( %x2 Int )( %x2p Int )( %x3 Bool )( %x3p Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_entry %x1 %x0 %x3 %x2 ) (= %x2p (- %x0 %x1 )) (= %x3p (>= %x2p 0 )) )
   (?bar@@YAHHH@Z1_exit %x1 %x0 %x3p %x2p )
  )
 )
)
(assert 
 (forall ( ( %x0 Int )( %x1 Int )( %x2 Int )( %x3 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_exit %x1 %x0 %x3 %x2 ) (= %x3 true ) )
   (?bar@@YAHHH@Z3_entry %x1 %x0 %x3 %x2 )
  )
 )
)
(assert 
 (forall ( ( %x0 Int )( %x1 Int )( %x2 Int )( %x3 Bool ) )
  (=>  
   (and (?bar@@YAHHH@Z1_exit %x1 %x0 %x3 %x2 ) (= %x3 false ) )
